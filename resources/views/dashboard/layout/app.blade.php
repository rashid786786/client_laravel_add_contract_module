    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
            ...
            <ul class="treeview-menu">
            <li class="active"><a href="{{route('contact.add')}}"><i class="fa fa-plus"></i> Add Contact</a></li>
            <li><a href="{{route('contact.show')}}"><i class="fa fa-list"></i> Contact List</a></li>
            </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset('dashboard/pages/layout/top-nav.html')}}"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
            <li><a href="{{asset('dashboard/pages/layout/boxed.html')}}"><i class="fa fa-circle-o"></i> Boxed</a></li>
            <li><a href="{{asset('dashboard/pages/layout/fixed.html')}}"><i class="fa fa-circle-o"></i> Fixed</a></li>
            <li><a href="{{asset('dashboard/pages/layout/collapsed-sidebar.html')}}"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
          </ul>
        </li>
        <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset('dashboard/pages/charts/chartjs.html')}}"><i class="fa fa-circle-o"></i> ChartJS</a></li>
            <li><a href="{{asset('dashboard/pages/charts/morris.html')}}"><i class="fa fa-circle-o"></i> Morris</a></li>
            <li><a href="{{asset('dashboard/pages/charts/flot.html')}}"><i class="fa fa-circle-o"></i> Flot</a></li>
            <li><a href="{{asset('dashboard/pages/charts/inline.html')}}"><i class="fa fa-circle-o"></i> Inline charts</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset('dashboard/pages/UI/general.html')}}"><i class="fa fa-circle-o"></i> General</a></li>
            <li><a href="{{asset('dashboard/pages/UI/icons.html')}}"><i class="fa fa-circle-o"></i> Icons</a></li>
            <li><a href="{{asset('dashboard/pages/UI/buttons.html')}}"><i class="fa fa-circle-o"></i> Buttons</a></li>
            <li><a href="{{asset('dashboard/pages/UI/sliders.html')}}"><i class="fa fa-circle-o"></i> Sliders</a></li>
            <li><a href="{{asset('dashboard/pages/UI/timeline.html')}}"><i class="fa fa-circle-o"></i> Timeline</a></li>
            <li><a href="{{asset('dashboard/pages/UI/modals.html')}}"><i class="fa fa-circle-o"></i> Modals</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset('dashboard/pages/forms/general.html')}}"><i class="fa fa-circle-o"></i> General Elements</a></li>
            <li><a href="{{asset('dashboard/pages/forms/advanced.html')}}"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
            <li><a href="{{asset('dashboard/pages/forms/editors.html')}}"><i class="fa fa-circle-o"></i> Editors</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset('dashboard/pages/tables/simple.html')}}"><i class="fa fa-circle-o"></i> Simple tables</a></li>
            <li><a href="{{asset('dashboard/pages/tables/data.html')}}"><i class="fa fa-circle-o"></i> Data tables</a></li>
          </ul>
        </li>
        <li>
